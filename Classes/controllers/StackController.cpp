...
CardView* StackController::findCardViewIn(Node* parent, int uid) const {
    // 在parent的直接子节点中查找uid匹配的CardView
...
void StackController::initView(const LevelConfig& cfg) {
    ...
    //撤销按钮回调清空（真正绑定在GameController::hookUndoButton中）
